    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">加入我们</h2>
          <p class="text-lg text-slate-400">我们本质上是创造者。是问题解决者和故事讲述者。我们是一个多元化的团队，由不同的个体组成，我们创造事物以让我们的客户满意。</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-6 lg:gap-10 max-w-xs mx-auto md:max-w-none -m-5">
          ...
          <div class="text-center p-5">
            ...
            <div class="font-bold text-slate-100 mb-1">热情</div>
          ...
          <div class="text-center p-5">
            ...
            <div class="font-bold text-slate-100 mb-1">激情</div>
            <p class="text-sm text-slate-400">You are passionate about digital products of any kind and are a builder at heart.</p>
          </div>
          <!-- Block #3 -->
          <div class="text-center p-5">
            ...
            <div class="font-bold text-slate-100 mb-1">成就者</div>
            <p class="text-sm text-slate-400">You are passionate about digital products of any kind and are a builder at heart.</p>
          </div>
        </div>
