    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="pt-16 pb-12 md:pt-32 md:pb-20">
        ...
        <div class="max-w-3xl pb-12 md:pb-20">
          ...
          <p class="text-lg text-slate-400">不同医院之间数据无法互通，导致患者需要重复测试医院项目，医链通在保护用户隐私的基础上通过区块链技术能够实现数据源头的安全可控共享，最终实现“让数据多跑路，让患者少跑腿“</p>
        </div>
        ...
        <div class="divide-y divide-slate-800">
          ...
          <div class="py-8 first-of-type:pt-0 last-of-type:pb-0">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">API 权限管理</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              ...
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">分区管理</h4>
                </div>
              ...
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">部分共享</h4>
                </div>
                <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">快速查询</h4>
                </div>
                <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
              </div>
            </div>
          ...
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">用户管理</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">数据分析</h4>
                </div>
                <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">消息</h4>
                </div>
                <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
              </div>
              <!-- Feature -->
          ...
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-6">安全密钥</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">隐私</h4>
                </div>
                <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">数据导出</h4>
                </div>
                <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">及时同步</h4>
                </div>
                <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
              </div>
            </div>
