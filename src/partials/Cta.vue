    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
        ...
        <div class="max-w-3xl mx-auto text-center">
          ...
          <h2 class="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">掌控自己的数据</h2>
          <p class="text-lg text-slate-400 mb-8">医疗领域上所有的 “乱数假文” 生成器往往会根据需要重复预定义的片段，这使得区块链能够大放异彩，让数据在用户手中掌控</p>
          <div>
