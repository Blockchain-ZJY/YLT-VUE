    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 md:pt-40">
        ...
        <div class="text-center pb-12 md:pb-20">
          <div class="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-purple-200 pb-3">集成&相关技术</div>
          <h1 class="h1 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">技术服务数字医疗</h1>
          <div class="max-w-3xl mx-auto">
            <p class="text-lg text-slate-400">医链通集成区块链/AI/分布式数据库/隐私保护等技术加速数字医疗建设</p>
          </div>
        </div>
