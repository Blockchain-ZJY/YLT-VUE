    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-16 md:pt-32">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">更快 更智能</h2>
                ...
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                      <div class="mb-5">
                        <div>
                          <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">针对安全性进行了优化</h3>
                          <p class="text-slate-400">针对用户体验和隐私进行优化。使用平台登录集成，提高数据重用程度</p>
                        </div>
                      </div>
                      <div>
                        <a class="btn-sm text-slate-300 hover:text-white transition duration-150 ease-in-out group [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-full before:pointer-events-none" href="#0">
                          <span class="relative inline-flex items-center">
                            更 多 <span class="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                          </span>
                        </a>
                      </div>
                    </div>
                ...
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                      <div>
                        <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">拓展性</h3>
                        <p class="text-slate-400">你的登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
                      </div>
                    </div>
                    <!-- Image -->
              ...
              <HighlighterItem>
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                      <div>
                        <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">可视化的选择</h3>
                        <p class="text-slate-400">快速应用过滤器以优化问题列表并创建自定义视图。</p>
                      </div>
                    </div>
                    <!-- Image -->
                    <div class="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">过滤</h4>
            </div>
            <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">可配置</h4>
            </div>
            <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">自适应</h4>
            </div>
            <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">权限管理</h4>
            </div>
            <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">数仓管理</h4>
            </div>
            <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">迅速构建</h4>
            </div>
            <p class="text-sm text-slate-400">登录框必须在用户便利性、隐私和安全之间找到恰当的平衡。</p>
          </div>
        </div>
