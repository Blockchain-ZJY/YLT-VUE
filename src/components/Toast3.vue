<template>
  <div v-show="open" role="alert">
    <div class="inline-flex min-w-80 px-4 py-2 rounded-lg text-sm bg-white dark:bg-slate-800 shadow-lg border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-100">
