      ...
      <div ref="modalContent" class="bg-white dark:bg-slate-800 border border-transparent dark:border-slate-700 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
        ...
        <div class="py-4 px-2">
          ...
          <div class="mb-3 last:mb-0">
            <div class="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase px-2 mb-2">最近搜索</div>
            <ul class="text-sm">
              <li>
          ...
          <!-- 最近页面 -->
          <div class="mb-3 last:mb-0">
            <div class="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase px-2 mb-2">最近页面</div>
            <ul class="text-sm">
              <li>
                <router-link class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group" to="#0" @click="$emit('close-modal')">
                  <svg class="w-4 h-4 fill-current text-slate-400 dark:text-slate-500 group-hover:text-white group-hover:text-opacity-50 shrink-0 mr-3" viewBox="0 0 16 16">
                  ...
                  <span><span class="font-medium">信息</span> - <span class="text-slate-600 dark:text-slate-400 group-hover:text-white">相关任务 / … / 工作</span></span>
                </router-link>
              </li>
              <li>
                <router-link class="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group" to="#0" @click="$emit('close-modal')">
                  ...
                  <span><span class="font-medium">信息</span> - <span class="text-slate-600 dark:text-slate-400 group-hover:text-white">聊天 / … / 药品出售</span></span>
                </router-link>
              </li>
            </ul>
          </div>
