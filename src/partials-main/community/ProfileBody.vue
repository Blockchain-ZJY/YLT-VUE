    ...
    <div class="relative px-4 sm:px-6 pb-8">
      ...
      <div class="-mt-16 mb-6 sm:mb-3">
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between sm:items-end">
          ...
          <div class="inline-flex -ml-1 -mt-1 mb-4 sm:mb-0">
            <img class="rounded-full border-4 border-white dark:border-slate-900" src="../../images/user-32-08.jpg" width="128" height="128" alt="Avatar" />
          </div>
      ...
      <header class="text-center sm:text-left mb-6">
        ...
        <div class="inline-flex items-start mb-2">
          <h1 class="text-2xl text-slate-800 dark:text-slate-100 font-bold">张医生</h1>
        ...
        <!-- Bio -->
        <div class="text-sm mb-3 text-stone-600">血管病、颅内肿瘤、椎管肿瘤、脑外伤等常见病。手术技能娴熟，尤其擅长颅底疾病的手术治疗。2011年10月以人才引进加盟金山医院神经外科，率先在金山地区开展急诊脑动脉瘤的开颅夹闭术</div>
        <!-- Meta -->
        <div class="flex flex-wrap justify-center sm:justify-start space-x-4">
          <div class="flex items-center">
            ...
            <span class="text-sm font-medium whitespace-nowrap text-slate-500 dark:text-slate-400 ml-2">武汉, 湖北</span>
          </div>
          <div class="flex items-center">
            <svg class="w-4 h-4 fill-current shrink-0 text-slate-400 dark:text-slate-500" viewBox="0 0 16 16">
      ...
      <div class="relative mb-6">
        ...
        <ul class="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
          <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            <a class="block pb-3 text-indigo-500 whitespace-nowrap border-b-2 border-indigo-500" href="#0">相关信息</a>
          </li>
          <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            <a class="block pb-3 text-slate-500 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 whitespace-nowrap" href="#0">联系</a>
          </li>
          <li class="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
            <a class="block pb-3 text-slate-500 dark:text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 whitespace-nowrap" href="#0">贡献</a>
          </li>
        </ul>
      </div>
      ...
      <div class="flex flex-col xl:flex-row xl:space-x-16">
        ...
        <div class="flex-1 space-y-5 mb-8 xl:mb-0">
          ...
          <!-- About Me -->
          <div>
            <h2 class="text-slate-800 dark:text-slate-100 font-semibold mb-2">关于我</h2>
            <div class="text-sm space-y-2 text-stone-600">
              <p>复旦大学神经外科学博士，主任医师，复旦大学副教授、硕导。上海市医学会神经外科分会第十届委员会委员，上海市医学会神经外科分会区县组副组长，上海市医学会医疗事故鉴定专家，上海市垂体瘤研究中心组员，第八、第九、第十周期金山区卫生系统优秀学科带头人</p>
            </div>
          </div>

          <!-- Departments -->
          <div>
            <h2 class="text-slate-800 dark:text-slate-100 font-semibold mb-2">部门</h2>
            <!-- Cards -->
            <div class="grid xl:grid-cols-2 gap-4">
              ...
              <div class="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm">
                ...
                <div class="grow flex items-center truncate mb-2">
                  ...
                  <div class="truncate">
                    <span class="text-sm font-medium text-slate-800 dark:text-slate-100">心血管</span>
                  </div>
                </div>
                <!-- Card content -->
                ...
                <div class="flex justify-between items-center">
                  ...
                  <!-- Link -->
                  <div>
                    <a class="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" href="#0">查看 -&gt;</a>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-white dark:bg-slate-800 p-4 border border-slate-200 dark:border-slate-700 rounded-lg shadow-sm">
                ...
                <div class="grow flex items-center truncate mb-2">
                  ...
                  <div class="truncate">
                    <span class="text-sm font-medium text-slate-800 dark:text-slate-100">神经外科</span>
                  </div>
                </div>
                <!-- Card content -->
                <div class="text-sm mb-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.</div>
