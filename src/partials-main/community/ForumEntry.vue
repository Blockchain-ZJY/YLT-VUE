  ...
  <article class="bg-white dark:bg-slate-800 shadow-md rounded border border-slate-200 dark:border-slate-700 p-5">
    ...
    <header class="pb-4">
      ...
      <div class="flex items-start space-x-3 mb-3">
        ...
        <!-- Upvote button -->
        <div class="shrink-0">
          <button class="text-xs font-semibold text-center h-12 w-12 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 rounded-lg flex flex-col justify-center items-center">
      ...
      <ul class="space-y-5">
        ...
        <li class="relative pl-9 space-y-5">
          ...
          <div class="flex items-start">
            ...
            <div class="absolute top-0 left-0">
              <button class="text-xs font-semibold text-left w-6 rounded-lg flex flex-col justify-center items-center text-slate-600 dark:text-slate-300 hover:text-indigo-500 dark:hover:text-indigo-500">
                <svg class="inline-flex fill-slate-400 dark:fill-slate-500 mt-1.5 mb-1.5" width="12" height="6" xmlns="http://www.w3.org/2000/svg">
                  <path d="m0 6 6-6 6 6z" />
                </svg>
                <div>44</div>
        ...
        <li class="relative pl-9 space-y-5">
          ...
          <div class="flex items-start">
            <!-- Comment upvote -->
            <div class="absolute top-0 left-0">
              <button class="text-xs font-semibold text-left w-6 rounded-lg flex flex-col justify-center items-center text-slate-600 dark:text-slate-300">
