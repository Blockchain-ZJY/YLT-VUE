<template>
  <div class="col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-lg border border-slate-200 dark:border-slate-700">
    <div class="flex flex-col h-full p-5">
      ...
      <footer class="mt-5">
        ...
        <div class="flex justify-between items-center">
          ...
          <div>
            <router-link class="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" :to="item.link">查看 -&gt;</router-link>
          </div>
        </div>
      </footer>
    </div>
