<template>
  <div class="space-y-8">
    <!-- Alert -->
    <div class="relative bg-indigo-200 dark:bg-indigo-500 rounded-lg p-5 min-w-60">
    ...
    <!-- White box -->
    <div class="bg-white dark:bg-slate-800 shadow-lg rounded-lg border border-slate-200 dark:border-slate-700 p-5 min-w-60">
