<template>
  <tbody class="text-sm">
    ...
    <tr>
      ...
      <td class="px-2 first:pl-5 last:pr-5 py-3 text-black whitespace-nowrap">
        <div>{{order.date}}</div>
      </td>
      <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
      ...
      <td class="px-2 first:pl-5 last:pr-5  text-stone-400 py-3 whitespace-nowrap">
    ...
    <tr :id="`description-${order.id}`" role="region" :class="!descriptionOpen && 'hidden'">
      <td colspan="10" class="px-2 first:pl-5 last:pr-5 py-3">
        <div class="flex items-center bg-slate-50 dark:bg-slate-900/30 dark:text-slate-400 p-3 -mt-3">
          ...
          <div class="italic text-slate-400">{{order.description}}</div>
        </div>
      </td>
    </tr>
  </tbody>
