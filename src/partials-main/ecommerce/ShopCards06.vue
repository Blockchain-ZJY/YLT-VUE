<template>
  <!-- Card 1 -->
  <div class="relative col-span-full sm:col-span-6 xl:col-span-3 bg-white dark:bg-slate-800 shadow-lg rounded-lg border border-slate-200 dark:border-transparent overflow-hidden">
    <!-- Image -->
