<template>
  <div class="flex flex-col col-span-full xl:col-span-4 bg-white dark:bg-slate-800 shadow-lg rounded-lg border border-slate-200 dark:border-slate-700">
    <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
      <h2 class="font-semibold text-slate-800 dark:text-slate-100">数据活动</h2>
    </header>
    <!-- Card content -->
    <div class="flex flex-col h-full">
      ...
      <div class="px-5 py-3">
        <div class="flex items-center">
          ...
          <div>
            ...
            <div class="text-sm text-slate-500 dark:text-slate-400">在线用户</div>
          </div>
        </div>
      </div>
        ...
        <div class="overflow-x-auto">
          <table class="table-auto w-full dark:text-slate-300">
            ...
            <thead class="text-xs uppercase text-slate-400 dark:text-slate-500">
              <tr>
                <th class="py-2">
                  <div class="font-semibold text-left text-slate-500">热门需求</div>
                </th>
                <th class="py-2">
                  <div class="font-semibold text-right text-slate-500">活动量</div>
                </th>
              </tr>
            </thead>
            <!-- Table body -->
            <tbody class="text-sm divide-y divide-slate-100 dark:divide-slate-700">
              ...
              <tr>
                <td class="py-2">
                  <div class="text-left text-slate-500">病例跨区调用</div>
                </td>
                <td class="py-2">
              ...
              <tr>
                <td class="py-2">
                  <div class="text-left text-slate-500">病例数据分析</div>
                </td>
                <td class="py-2">
              ...
              <tr>
                <td class="py-2">
                  <div class="text-left text-slate-500">病例数据存证</div>
                </td>
                <td class="py-2">
              ...
              <tr>
                <td class="py-2">
                  <div class="text-left text-slate-500">病例数据上传</div>
                </td>
                <td class="py-2">
      ...
      <div class="text-right px-5 pb-4">
        <router-link class="text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400" to="#0">实时查看-&gt;</router-link>
      </div>
    </div>
  </div>
</template>
