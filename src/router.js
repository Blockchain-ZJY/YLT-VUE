...
import Integrations from './src/Integrations.vue'
import IntegrationsSingle from './src/IntegrationsSingle.vue'
import Pricing from './src/Pricing.vue'
import Customers from './src/Customers.vue'
import Customer from './src/Customer.vue'
import Changelog from './src/Changelog.vue'
import SignIn from './src/SignIn.vue'
...
import Customersmain from './pages/ecommerce/Customers.vue'
...
import Changelogmain from './pages/utility/Changelog.vue'
...
import ResetPasswordmain from './pages/ResetPassword.vue'
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/utility/Changelogmain',
      component: Changelogmain
    },
    {
