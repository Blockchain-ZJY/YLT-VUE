          ...
          <div class="space-y-8">
            ...
            <div>
              ...
              <div class="grid sm:grid-cols-2 lg:grid-cols-4 lg:sidebar-expanded:grid-cols-2 xl:sidebar-expanded:grid-cols-4 gap-6">
                ...
                <!-- Item -->
                <div class="bg-slate-100 dark:bg-slate-800 rounded-lg text-center p-5">
            ...
            <div>
              ...
              <div class="grid sm:grid-cols-2 gap-6">
                ...
                <!-- Item -->
                <div class="w-full p-3 rounded-lg text bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
