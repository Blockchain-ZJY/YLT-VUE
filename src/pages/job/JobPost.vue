        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
          ...
          <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
              ...
              <div class="bg-white dark:bg-slate-800 p-5 shadow-lg rounded-lg border border-slate-200 dark:border-slate-700 mb-6 lg:hidden">
...
import JobListItem from '../../partials-main/job/JobListItem.vue'
