        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8 w-full">
          ...
          <div class="max-w-5xl mx-auto flex flex-col lg:flex-row lg:space-x-8 xl:space-x-16">
            ...
            <div>
              ...
              <!-- Image -->
              <figure class="mb-6">
                <img class="w-full rounded-lg" src="../../images/meetup-image.jpg" width="640" height="360" alt="Meetup" />
              </figure>
              ...
              <div>
                ...
                <div class="grid grid-cols-3 gap-4 my-6">
                  <a class="block" href="#0">
                    <img class="w-full rounded-lg" src="../../images/meetup-photo-01.jpg" width="203" height="152" alt="Meetup photo 01" />
                  </a>
                  <a class="block" href="#0">
                    <img class="w-full rounded-lg" src="../../images/meetup-photo-02.jpg" width="203" height="152" alt="Meetup photo 02" />
                  </a>
                  <a class="block" href="#0">
                    <img class="w-full rounded-lg" src="../../images/meetup-photo-03.jpg" width="203" height="152" alt="Meetup photo 03" />
                  </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div class="space-y-8 sm:space-y-5 my-6 lg:mb-0">
                  <!-- Related item -->
                  <article class="flex bg-white dark:bg-slate-800 shadow-lg rounded-lg border border-slate-200 dark:border-slate-700 overflow-hidden">
                    <!-- Image -->
                  ...
                  <li>
                    <div class="flex justify-between">
                      <div class="grow flex items-center">
                        ...
                        <div class="truncate">
                          <span class="text-sm font-medium text-slate-800 dark:text-slate-100">张医生</span>
                        </div>
                      </div>
