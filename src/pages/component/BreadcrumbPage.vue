          ...
          <div class="border-t border-slate-200 dark:border-slate-700">
            ...
            <div class="space-y-8 mt-8">
              ...
              <div>
                ...
                <div class="px-6 py-8 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg">
                  <div class="text-center">
                    ...
                    <ul class="inline-flex flex-wrap text-sm font-medium">
                      ...
                      <li class="after:content-['/'] last:after:hidden after:text-slate-400 dark:after:text-slate-600 after:px-2">
                        <a class="text-slate-500 dark:text-slate-400 hover:text-indigo-500 dark:hover:text-indigo-500" href="#0">设置</a>
                      </li>
                      <li class="after:content-['/'] last:after:hidden after:text-slate-400 dark:after:text-slate-600 after:px-2">
                        <a class="text-slate-500 dark:text-slate-400 hover:text-indigo-500 dark:hover:text-indigo-500" href="#0">消息</a>
                      </li>
                    </ul>
                    <!-- End -->
                  </div>
