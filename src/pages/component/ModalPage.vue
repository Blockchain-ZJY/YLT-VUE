                      ...
                      <div class="px-5 pt-4 pb-1">
                        <div class="text-sm">
                          ...
                          <div class="space-y-2">
                            ...
                            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 添加相关用药说明</p>
                          </div>
                        </div>
                      </div>
                      <!-- Modal footer -->
                    ...
                    <ModalBlank id="success-modal" :modalOpen="successModalOpen" @close-modal="successModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click.stop="successModalOpen = false">取消</button>
                    ...
                    <ModalBlank id="danger-modal" :modalOpen="dangerModalOpen" @close-modal="dangerModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click.stop="dangerModalOpen = false">取消</button>
                    ...
                    <ModalBlank id="info-modal" :modalOpen="infoModalOpen" @close-modal="infoModalOpen = false">
                      <div class="p-5 flex space-x-4">
                        ...
                        <div>
                          ...
                          <!-- Modal footer -->
                          <div class="flex flex-wrap justify-end space-x-2">
                            <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click.stop="infoModalOpen = false">取消</button>
                ...
                <div class="flex flex-wrap items-center -m-1.5">
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="feedback-modal" :modalOpen="feedbackModalOpen" @close-modal="feedbackModalOpen = false" title="Send Feedback">
                      ...
                      <div class="px-5 py-4 border-t border-slate-200 dark:border-slate-700">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click.stop="feedbackModalOpen = false">取消</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalAction id="integration-modal" :modalOpen="integrationModalOpen" @close-modal="integrationModalOpen = false">
                      ...
                      <!-- Modal footer -->
                      <div class="flex flex-wrap justify-end space-x-2">
                        <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click.stop="integrationModalOpen = false">取消</button>
                  ...
                  <div class="m-1.5">
                    ...
                    <ModalBasic id="feedback-modal" :modalOpen="planModalOpen" @close-modal="planModalOpen = false" title="Change your Plan">
                      ...
                      <div class="px-5 py-4">
                        <div class="flex flex-wrap justify-end space-x-2">
                          <button class="btn-sm border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-600 dark:text-slate-300" @click.stop="planModalOpen = false">取消</button>
